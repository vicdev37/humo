...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/fullpage.js/dist/jquery.fullpage.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
 * fullPage 2.9.7
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"../src/js/auto-complete.js":[function(require,module,exports) {
var define;
...
var _autoComplete = _interopRequireDefault(require("./auto-complete.js"));
...
$(document).ready(() => {
  ...
  const getPeople = async () => {
    const res = await _axios.default.get(`${url}/people`, config);
    people = res.data;
  };
  ...
  new _autoComplete.default({
    ...
    source: function (term, suggest) {
      ...
      _axios.default.get(`${url}/people`, config).then(res => {
  ...
  $('.form').submit(async evt => {
    ...
    const res = await _axios.default.post(`${url}/people/${id}`, data, config);
    console.log('id', id);
    registered = true;
...
},{"fullpage.js":"../node_modules/fullpage.js/dist/jquery.fullpage.js","jquery":"../node_modules/jquery/dist/jquery.js","./auto-complete.js":"../src/js/auto-complete.js","axios":"../node_modules/axios/index.js","sweetalert2":"../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
